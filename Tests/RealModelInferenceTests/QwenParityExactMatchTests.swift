...
/// via `scripts/qwen25_pytorch_reference.py logit-parity`. Greedy choices can only flip
/// where the reference's own top-1/top-2 gap is inside this band.
private let maxObservedANELogitError = 0.7
